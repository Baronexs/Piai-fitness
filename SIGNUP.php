        ...
        <div id="layoutAuthentication_content">
            <main>
                <div class="card-body">
                    ...
                    <!-- Form Sign Up -->
                    <form class="mx-auto form-container mt-5" method="post" action="">
                        <h4 class="text-center">Sign Up</h4>
                        <div class="mb-3 mt-3">
                            <label for="inputNewEmailAddress" class="form-label">Email</label>
                            <input class="form-control py-4" name="email" id="inputNewEmailAddress" type="email" placeholder="Enter email address" required />
                        </div>
                        <div class="mb-3">
                            <label for="inputNewPassword" class="form-label">Password</label>
                            <input class="form-control py-4" name="password" id="inputNewPassword" type="password" placeholder="Enter password" required />
                        </div>
                        <div class="form-group d-flex align-items-center justify-content-between mt-4 mb-0">
                            <button class="btn btn-secondary" name="signup" type="submit">Sign Up</button>
                        </div>
                    </form>
                </div>
            </main>
